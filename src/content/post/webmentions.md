...
pinned: true
aiSummary: 这篇文章详细介绍了为Astro博客添加Webmentions社交互动功能的完整流程，包括通过IndieLogin添加身份验证链接证明所有权、在Webmention.io创建账户获取API密钥、配置环境变量以及使用Bridgy将网站连接到各社交媒体账户，最后还提供了通过Webmentions Rocks发送测试提及的验证方法。
