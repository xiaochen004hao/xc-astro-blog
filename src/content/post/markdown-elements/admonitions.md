...
aiSummary: 这篇文章系统介绍了Astro主题中提示框组件的使用方法，通过将Markdown内容包裹在三重冒号中即可创建note笔记、tip提示、important重要、warning警告和caution注意五种提示框类型，每种类型配有不同图标和配色方案以区分信息层级，还演示了自定义标题和GitHub仓库卡片等进阶功能。
